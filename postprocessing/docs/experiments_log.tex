...
\begin{figure}[H]
    ...
    \caption{Sinistra: Percorso di estrazione (linea rossa) per il diagramma di Hovmöller (Exp A). Destra: Diagramma di Hovmöller (Exp A).}
    \label{fig:varianceA}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.25\textwidth]{fig_ExpC_bathymetry_3D.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{fig_ExpE_snapshots.png}
