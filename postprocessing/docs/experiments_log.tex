...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{fig_ExpC_bathymetry_3D_0.png}
...
Per analizzare questo fenomeno, in Figura \ref{fig:shoaling_profile} confronto l'evoluzione dell'ampiezza massima osservata lungo la costa (blu) con la curva teorica (rosso), con focus sul range 400 km - 1000 km per escludere il transiente iniziale e gli effetti di bordo a Nord.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{fig_ExpC_shoaling_profile_0.png}
...
Si osserva che:
\begin{itemize}
    \item Nella prima parte del dominio valido, l'ampiezza misurata sembra seguire il trend di crescita teorico.
    \item Successivamente si nota una deviazione (forse dovuta a dispersione numerica).
    \item Il valore finale osservato è vicino a quello teorico, sebbene, data l'evoluzione non monotona nel mezzo, questo accordo puntuale potrebbe essere una coincidenza.
\end{itemize}

Un altro effetto fondamentale della profondità variabile è sulla \textbf{Velocità di Fase}, visibile nel confronto delle serie temporali al punto Nord (Figura \ref{fig:shoaling}).

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{fig_ExpC_shoaling_comparison_0.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{fig_ExpC_hovmoller_comparison_0.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{fig_ExpC_snapshots_0.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{fig_ExpD_resolution_comparison_0.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{fig_ExpD_hovmoller_0.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{fig_ExpE_snapshots_0.png}
    \caption{Snapshots Exp E ($f=0$).}
    \label{fig:expE_snap}
\end{figure}
