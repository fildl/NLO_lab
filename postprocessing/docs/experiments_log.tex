...
Per analizzare questo fenomeno, in Figura \ref{fig:shoaling_profile} confrontiamo l'evoluzione dell'ampiezza massima osservata lungo la costa (blu) con la curva teorica (rosso), focalizzandoci sul range 400 km - 1000 km per escludere il transiente iniziale e gli effetti di bordo a Nord.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{fig_ExpC_shoaling_profile.png}
