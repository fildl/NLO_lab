...
\textbf{D} & 3 ($\Delta x \approx 3.3$km) & 20 & Piatta 100m & Alta Risoluzione. \\ \hline
\end{tabular}
...
\begin{itemize}
    ...
    \item \textbf{Exp D}: Modificato \texttt{namelist\_cfg} per \texttt{nn\_GYRE=3}, \texttt{rn\_Dt=20} e ripristinato \texttt{usrdef\_zgr.F90} a piatto.
\end{itemize}
