...
\begin{frame}{Exp B: Sensibilità all'Ampiezza}
    ...
    \begin{columns}
        \begin{column}{0.4\textwidth}
            \begin{figure}
                \centering
                \includegraphics[height=0.45\textheight,keepaspectratio]{../postprocessing/fig_expB_location.png}
            \end{figure}
        \end{column}
        \begin{column}{0.6\textwidth}
            \begin{figure}
                \centering
                \includegraphics[height=0.45\textheight,keepaspectratio]{../postprocessing/fig_expB_compare_linearity.png}
            \end{figure}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Exp C: Confronto Velocità di Fase}
    ...
    \begin{figure}
        \centering
        \only<1>{\includegraphics[width=0.75\textwidth]{../postprocessing/fig_ExpC_shoaling_comparison_1core.png}}%
        \only<2>{\includegraphics[width=0.9\textwidth]{../postprocessing/fig_ExpC_hovmoller_comparison_1core.png}}
    \end{figure}
\end{frame}
