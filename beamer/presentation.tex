...
\begin{frame}{Exp A: Punto Anfidromico e Confronto}
    \begin{columns}
        \begin{column}{0.4\textwidth}
            ...
            \vspace{0.3cm}
            \textbf{Letteratura (M2 Adriatico):}
            La marea lunare semidiurna (M2) mostra la stessa struttura rotatoria con un nodo centrale.
            
            \vspace{0.3cm}
            \textit{Il modello idealizzato cattura la fisica del bacino.}
        \end{column}
        \begin{column}{0.6\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=0.45\linewidth,height=0.7\textheight,keepaspectratio]{../postprocessing/fig_expA_ssh_variance_contour.png}
                \hfill
    ...
    \end{columns}
    \vfill
    \tiny \textit{Ref: Cushman-Roisin et al., 2001}
\end{frame}
