...
\begin{frame}{Exp B: Sensibilità all'Ampiezza}
    ...
    \begin{columns}
        ...
        \begin{column}{0.6\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=\linewidth,height=0.5\textheight,keepaspectratio]{../postprocessing/fig_expB_compare_linearity.png}
            \end{figure}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Exp C: Dinamica e Raggio di Rossby}
    \begin{columns}
        \begin{column}{0.45\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=0.9\linewidth,height=0.45\textheight,keepaspectratio]{../postprocessing/fig_expA_initial_state.png}
                \vspace{0.2cm}
                \includegraphics[width=0.9\linewidth,height=0.45\textheight,keepaspectratio]{../postprocessing/fig_expC_1core_initial_state.png}
            \end{figure}
        \end{column}
...
\begin{frame}{Exp D: Alta Risoluzione (5km)}
    ...
    \begin{itemize}
        \item Aumento della risoluzione temporale ($\Delta t$ = 20 s) per stabilità.
        \item L'alta risoluzione riduce la dissipazione numerica (picchi più marcati).
        \item La velocità di fase e la struttura dell'onda rimangono coerenti.
    \end{itemize}
    ...
    \begin{columns}
        \begin{column}{0.55\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=\linewidth,height=0.6\textheight,keepaspectratio]{../postprocessing/fig_ExpD_resolution_comparison.png}
            \end{figure}
        \end{column}
        \begin{column}{0.45\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=\linewidth,height=0.6\textheight,keepaspectratio]{../postprocessing/fig_ExpD_hovmoller.png}
            \end{figure}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Conclusioni}
    \begin{enumerate}
        \setlength{\itemsep}{1em}
        \item \textbf{Dinamica Kelvin}: Il modello riproduce correttamente l'onda di Kelvin e lo sviluppo di un punto anfidromico (Exp A, D).
        \item \textbf{Linearità}: Risposta perfettamente lineare al variare  dell'ampiezza (Exp B).
        \item \textbf{Batimetria}: La velocità di fase dell'onda mostra una dipendenza dalla profondità ($c=\sqrt{gH}$) in accordo con la teoria (Exp C).
